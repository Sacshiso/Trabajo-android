...
public class PersonalFragment extends Fragment {
    ...
    //se crean las variables para el funcionamiento
    View vista;
    Activity actividad;
    CardView cardAgregar,cardVer,cardSolicitudes;
    ImageView retroceso,platos;
    ...
    //se hace el llamado a las Carview creadas
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        cardSolicitudes=vista.findViewById(R.id.cardSolicitudes);
        platos=vista.findViewById(R.id.platos);
        eventos();
        return vista;
    }
    private void eventos() {
        cardAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                interfaceComunicaPersonal.agregarPersonal();
            }
        });
        cardVer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                interfaceComunicaPersonal.verPersonal();
            }
        });
        ...
        platos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                interfaceComunicaPersonal.irPlatos();
            }
        });
        cardSolicitudes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                interfaceComunicaPersonal.solicitudesPersonal();
            }
        });
